package ram.tutorials.elasticsearch.client;
...
public class TutorialClient {
    ...
    public TutorialClient(Client client, URI root) {
        this.client = client;
        this.clientBuilder = null;
        this.root = root;
    }

    public TutorialClient(JerseyClientBuilder clientBuilder, URI root) {
        this.client = null;
    ...
    private static Client buildClient(JerseyClientBuilder clientBuilder) {
        ...
        return builder
            ...
            .using(jerseyConfig).build("tutorialClient");
    }
}
